import sqlLib
from sqlLib import cek_present_dosen, get_kelas, get_matkul_late_test, get_matkul_test, get_nim, get_matkul, get_matkul_late, insert_main, get_username, cek_id, get_kelas, cek_present
    ...
    if json_data == None:
        ...
        if 'id' not in json_data or 'matakuliah' not in json_data:
            ...
            if cek == False:
                ...
                if status==0:
                    matkul_hadir = get_matkul_test(kelas)
                    if matkul_hadir==None:
                        matkul_telat = get_matkul_late_test(kelas)
